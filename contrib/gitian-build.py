...
def build():
    ...
    os.makedirs('pigeoncoin-binaries/' + args.version, exist_ok=True)
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/pigeoncoin-*.tar.gz build/out/src/pigeoncoin-*.tar.gz ../pigeoncoin-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/pigeoncoin-*-win-unsigned.tar.gz inputs/pigeoncoin-win-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/pigeoncoin-*.zip build/out/pigeoncoin-*.exe ../pigeoncoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/pigeoncoin-*-osx-unsigned.tar.gz inputs/pigeoncoin-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/pigeoncoin-*.tar.gz build/out/pigeoncoin-*.dmg ../pigeoncoin-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/pigeoncoin-*win64-setup.exe ../pigeoncoin-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/pigeoncoin-*win32-setup.exe ../pigeoncoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/pigeoncoin-osx-signed.dmg ../pigeoncoin-binaries/'+args.version+'/pigeoncoin-'+args.version+'-osx.dmg', shell=True)
