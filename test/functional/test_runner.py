...
BASE_SCRIPTS= [
    ...
    'dip3-deterministicmns.py', # NOTE: needs x21s_hash to pass
    'wallet-hd.py',
    'walletbackup.py',
    # vv Tests less than 5m vv
    'p2p-fullblocktest.py', # NOTE: needs x21s_hash to pass
    ...
    'listtransactions.py',
    'multikeysporks.py',
    'llmq-signing.py', # NOTE: needs x21s_hash to pass
    'llmq-chainlocks.py', # NOTE: needs x21s_hash to pass
    'llmq-simplepose.py', # NOTE: needs x21s_hash to pass
    'llmq-is-cl-conflicts.py', # NOTE: needs x21s_hash to pass
    'llmq-is-retroactive.py', # NOTE: needs x21s_hash to pass
    'llmq-dkgerrors.py', # NOTE: needs x21s_hash to pass
    'dip4-coinbasemerkleroots.py', # NOTE: needs x21s_hash to pass
    # vv Tests less than 60s vv
    'sendheaders.py', # NOTE: needs x21s_hash to pass
    'zapwallettxes.py',
    'importmulti.py',
    'mempool_limit.py',
    'merkle_blocks.py',
    ...
    'invalidblockrequest.py', # NOTE: needs x21s_hash to pass
    'invalidtxrequest.py', # NOTE: needs x21s_hash to pass
