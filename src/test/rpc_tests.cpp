...
BOOST_AUTO_TEST_CASE(rpc_convert_values_generatetoaddress)
{
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"101", "nNn2NoNAxUivfX5wfDiPeKCWke4y49jxpK"}));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "nNn2NoNAxUivfX5wfDiPeKCWke4y49jxpK");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"101", "nNn2NoNAxUivfX5wfDiPeKCWke4y49jxpK"}));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "nNn2NoNAxUivfX5wfDiPeKCWke4y49jxpK");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"1", "nNn2NoNAxUivfX5wfDiPeKCWke4y49jxpK", "9"}));
