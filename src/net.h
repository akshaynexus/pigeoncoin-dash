...
public:
    ...
    void RelayInv(CInv &inv, int minProtoVersion = MIN_PEER_PROTO_VERSION, bool fAllowMasternodeConnections = false);
    void RelayInvFiltered(CInv &inv, const CTransaction &relatedTx, int minProtoVersion = MIN_PEER_PROTO_VERSION, bool fAllowMasternodeConnections = false);
    ...
    void RelayInvFiltered(CInv &inv, const uint256 &relatedTxHash, int minProtoVersion = MIN_PEER_PROTO_VERSION, bool fAllowMasternodeConnections = false);
