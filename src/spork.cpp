...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_22_MIN_PEER_PROTOCOL_VERSION,     PROTOCOL_RVN_VERSION), // Default to current mainnet proto version
    MAKE_SPORK_DEF(SPORK_23_PS_MORE_PARTICIPANTS,          0), // ON
};
