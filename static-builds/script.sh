...
mkdir -p ~/pigeoncoin-dash/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/pigeoncoin-dash/depends/SDKs/MacOSX10.11.sdk.tar.gz
cd ~/pigeoncoin-dash/depends/SDKs && tar -xf MacOSX10.11.sdk.tar.gz 
