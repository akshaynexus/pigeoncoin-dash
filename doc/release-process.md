...
Codesigner only: Sign the osx binary:
    ...
    transfer pigeoncoin-osx-unsigned.tar.gz to osx for signing
    tar xf pigeoncoin-osx-unsigned.tar.gz
...
Codesigner only: Sign the windows binaries:
    ...
    tar xf pigeoncoin-win-unsigned.tar.gz
...
- Announce the release:
  ...
  - Release on Pigeon forum: https://www.dash.org/forum/topic/official-announcements.54/
