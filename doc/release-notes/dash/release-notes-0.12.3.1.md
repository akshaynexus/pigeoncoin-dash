...
- [`a46bf120b`](https://github.com/dashpay/dash/commit/a46bf120b) Don't directly call "wine test_pigeon.exe" and let "make check" handle it (#1841)
...
- [`d9058aa04`](https://github.com/dashpay/dash/commit/d9058aa04) Increase travis timeout for "wine src/test/test_pigeon.exe" call (#1820)
- [`10786fe8e`](https://github.com/dashpay/dash/commit/10786fe8e) Use travis_wait for "wine test_pigeon.exe" call to fix timeouts (#1812)
