...
git clone https://github.com/pigeonpay/pigeon
git clone https://github.com/pigeonpay/gitian.sigs.git
```
...
Gitian builds' in [doc/release-process.md](release-process.md#setup-and-perform-gitian-builds) in the Pigeon Core repository.
...
```bash
    ...
    From https://github.com/pigeonpay/pigeon
...
cd /some/root/path/
git clone https://github.com/pigeonpay/pigeon-detached-sigs.git
...
[pigeon/gitian.sigs](https://github.com/pigeonpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
